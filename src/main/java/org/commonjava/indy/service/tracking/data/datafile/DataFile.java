...
public final class DataFile
{
    ...
    public void delete( final ChangeSummary summary ) throws IOException
    {
        if ( file.exists() )
        {
    ...
    public void writeString( final String content, final ChangeSummary summary ) throws IOException
    {
    ...
    public void writeLines( final List<String> lines, final ChangeSummary summary ) throws IOException
    {
        FileUtils.writeLines( file, lines );
        events.modified( file, summary );
    }

    public void appendString( final String content, final ChangeSummary summary ) throws IOException
    {
