 ...
 */
package org.commonjava.indy.service.tracking.concurrent;
...
public class Locker<K>
{
    ...
    public <T> T lockAnd( K key, long timeoutSeconds, Function<K, T> function,
                          BiFunction<K, ReentrantLock, Boolean> lockFailedFunction )
    {
        Logger logger = LoggerFactory.getLogger( getClass() );
