...
{
    group( Group.class, false, "group", "groups", "g" ), remote( RemoteRepository.class, false, "remote", "remotes",
                                                                 "repository", "repositories", "r" ), hosted(
                HostedRepository.class, true, "hosted", "hosted", "deploy", "deploys", "deploy_point", "h", "d" );
