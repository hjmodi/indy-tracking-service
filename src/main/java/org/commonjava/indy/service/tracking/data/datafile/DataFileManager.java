...
public class DataFileManager
{
    ...
    public DataFileManager( final IndyTrackingConfiguration config )
    {
        this.config = config;
    }

    public File getDataFile( final String... pathParts )
    {
        final File base = config.baseDir();
        return Paths.get( base.getAbsolutePath(), pathParts ).toFile();
    }
