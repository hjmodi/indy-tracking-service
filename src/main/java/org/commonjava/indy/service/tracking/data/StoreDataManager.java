...
public interface StoreDataManager
{
     ...
     */
    Optional<ArtifactStore> getArtifactStore( StoreKey key ) throws IndyDataException;
    ...
    boolean storeArtifactStore( ArtifactStore store, final ChangeSummary summary, boolean skipIfExists,
                                boolean fireEvents, EventMetadata eventMetadata ) throws IndyDataException;
     ...
     */
    void clear( final ChangeSummary summary ) throws IndyDataException;
    ...
    Set<Group> affectedBy( Collection<StoreKey> keys ) throws IndyDataException;
