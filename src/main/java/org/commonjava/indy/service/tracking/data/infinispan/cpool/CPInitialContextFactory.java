                ...
                implements InitialContextFactory
{
    ...
    @Override
    public synchronized Context getInitialContext( final Hashtable<?, ?> hashtable ) throws NamingException
    {
        if ( context == null )
        {
                    ...
                    extends InitialContext
    {
        ...
        public CPInitialContext( final Hashtable<?, ?> environment ) throws NamingException
        {
        }
