...
import org.commonjava.indy.service.tracking.exception.InvalidArtifactStoreException;
                ...
                implements StoreValidator
{
    ...
    @Inject
    IndyTrackingConfiguration configuration;
            ...
            if ( StoreType.remote == artifactStore.getType() )
            {
                                                              ...
                                                              .equalsIgnoreCase( StoreValidationConstants.HTTPS ) )
                {
                    ...
                    LOGGER.warn( "\n\t\t\t=> Allowed Remote Repositories by Config File: "
                                                 + configuration.remoteNoSSLHosts().orElse( Collections.emptyList() )
                                                 + "\n" );
                                                                           ...
                                                                           RemoteRepository remoteRepository )
    {
        ...
        for ( String remoteHost : remoteNoSSLHosts )
        {
            ...
            if ( allowedNonSSLHostname( remoteHost, host ) )
            {
                ...
                LOGGER.warn( "=> NON-SSL RemoteRepository with URL: " + host + " is ALLOWED under RULE: "
                                             + remoteHost );
                return new ArtifactStoreValidateData.Builder( remoteRepository.getKey() ).setRepositoryUrl(
