...
public class FoloTrackingListener
{
    ...
    private TrackedContentEntry createEntry( final TrackingKey trackingKey, final StoreKey affectedStore,
                                             ...
                                             final StoreEffect effect, final FileEvent event )
                    throws IndyWorkflowException
    {
        ...
        entry = new TrackedContentEntry( trackingKey, affectedStore, accessChannel, event.getSourceLocation(), path,
                                         effect, event.getSize(), event.getMd5(), event.getSha1(),
                                         event.getChecksum() );
