...
import org.commonjava.indy.service.tracking.model.ApplicationStatus;
...
public class ResponseHelper
{
    ...
    private Response formulateResponse( final ApplicationStatus status, final Throwable error, final String message,
